...
from models.network_origin import SwinIR as swinir
...
def main():
    ...
    if args.model==0:
        ...
        model_path = '/home/shiminghao/smh/tmp_S2R/transfer-learning/435000_G.pth'
    elif args.model ==1:
    ...
    Tester=Test(model_path, args.savepath, kernel, scale, args.model, args.num_of_adaptation)
    P=[]
